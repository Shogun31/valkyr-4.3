...
function checkDays(date) {
    ...
    "amsterdam": "Hollanda :flag_nl:",
			...
			const yukleniyor = await msg.channel.send(`:hourglass_flowing_sand: Sunucu bilgileri araştırılıyor...`);
...
module.exports.help = {
    name: 'sunucubilgi',
    description: 'Sunucu hakkında bilgi verir.',//Vinnie tarafından kodlanmıştır.
    usage: 'sunucubilgi'
};