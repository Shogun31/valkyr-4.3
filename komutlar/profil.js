...
moment.locale('tr-TR');
  ...
  if (!member) return message.reply(':no_entry: Bir kullanıcı belirtmelisin!')

        let serverSize = message.guild.memberCount;//Vinnie tarafından kodlanmıştır.
...
exports.help = {//Vinnie tarafından kodlanmıştır.
  name: 'profil',
  description: 'Etiketlediğiniz profil hakkında bilgi verir.',
